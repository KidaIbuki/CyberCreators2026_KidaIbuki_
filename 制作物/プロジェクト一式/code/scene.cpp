...
CScene* CScene::Create(MODE mode)
{
	...
	{
	case MODE_TITLE:
		CManager::GetInstance()->GetCamera()->TitleCamera();
		pScene = CTitle::Create();
		break;
	case MODE_TITLE2:
		CManager::GetInstance()->GetCamera()->ResetCamera();
		pScene = CTitleSecond::Create();
		break;
		//ステージ1
	case MODE_GAME:
		CManager::GetInstance()->GetCamera()->ResetCamera();   
...
// オブジェクトを保存
//====================================
CSaveObject* CScene::CreateSaveObject(CObject* pObject)
{
	CSaveObject* pSave = new CSaveObject(pObject);
	pSave->Create(m_pTop, m_pCur);
	return pSave;
}
//====================================
// ポーズ中のオブジェクトを保存
//====================================
CSaveObject* CScene::CreateSaveObjectPause(CObject* pObject)
{
	CSaveObject* pSavePause = new CSaveObject(pObject);
	pSavePause->Create(m_pPauseTop, m_pPauseCur);
	return pSavePause;
}
