...
void CObject3D::UpdateUV()
{
	...
	//テクスチャ座標の設定
	pVtx[0].tex.y += m_PosTexV.y;
	pVtx[1].tex.y += m_PosTexV.y;
	pVtx[2].tex.y += m_PosTexV.y;
	pVtx[3].tex.y += m_PosTexV.y;

	//テクスチャ座標の設定
	pVtx[0].tex.x += m_PosTexV.x;
	pVtx[1].tex.x += m_PosTexV.x;
	pVtx[2].tex.x += m_PosTexV.x;
	pVtx[3].tex.x += m_PosTexV.x;
...
// UV座標の移動量設定
//================================================
void CObject3D::SetUVmove(D3DXVECTOR2 move)
{
	m_PosTexV = move;
}
